...
const CACHE_NAME = 'fce-portal-v9.3.4';
const FONT_CACHE = 'fce-fonts-v9.3.4';

const SHELL_FILES = [
  './index.html',
  './manifest.json',
  './nexus-contrast-tokens.css',   /* v9.3.4: token system centralizado */
  './nexus-modules.js',            /* v9.3.4: arquitectura modular */
...
self.addEventListener('install', event => {
  console.log('NEXUS v9.3.4 — cacheando shell');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[FCE SW] Activate v9.3.4 — limpiando caches viejos');
  self.skipWaiting();
  event.waitUntil(
    caches.keys()
